var number_of_images = 20; // Modify this parameter to change number of images
...
$(function(){
  ...
  $('#random_image_swapper').attr('src', $('#random_image_swapper').attr('src').replace(String("pic" + current_image), String("pic" + next_image)));
...
preloadImages = function() {
  for(var i = 2; i <= number_of_images; i++) {
    ...
    }).attr('src', $('#random_image').attr('src').replace(String("pic" + current_image), String("pic" + i)));
  }
}
