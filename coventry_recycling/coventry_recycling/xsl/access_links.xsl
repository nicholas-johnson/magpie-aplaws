  ...
  <xsl:template name="accessLinks">
    <div id="access_links">
      <ul>
         ...
         <li><a href="/ccm/portal/" accesskey="1" title="Recycling Homepage, access key: 1">Home page</a></li>
         <li><a href="http://www.coventry.gov.uk/ccm/coventry/accessibility" accesskey="0" title="Access key details: access key 0">Access keys details</a></li>
      </ul>
    </div>
  </xsl:template>
