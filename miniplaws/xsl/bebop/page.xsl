...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="pageHeader">
		<div id="header">
			<xsl:call-template name="councilLogo" />
			<h1><xsl:call-template name="councilName" /></h1>
			<ul>
				<li><a href="{$dispatcher-prefix}">Home</a></li>
				<li><a href="{$dispatcher-prefix}/search">Search</a></li>
				<li><a href="{$dispatcher-prefix}/atoz">A to Z</a></li>
			</ul>
		</div>
	</xsl:template>
